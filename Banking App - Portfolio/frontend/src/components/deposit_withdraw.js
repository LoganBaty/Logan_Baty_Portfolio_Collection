...
export default function DepositWithdraw() {
  ...
  async function submit(e) {
    ...
    try {
      ...
      const msg =
        mode === "deposit"
          ? `Deposit of $${amt} to ${form.account} complete!`
          : `Withdrawal of $${amt} from ${form.account} complete!`;
    ...
    <>
      <div className="accounts-container">
        <div className="accounts-card">
          ...
          <p className="accounts-subtitle">Perform account transactions safely and easily</p>
          ...
          <div className="table-wrap" style={{ marginTop: 12 }}>
            <table className="table">
              <thead><tr><th>Account</th><th style={{ textAlign: "right" }}>Balance</th></tr></thead>
              <tbody>
          ...
          <form className="form-card" style={{ marginTop: 16 }} onSubmit={submit}>
            <div className="form-row">
              ...
              <div className="form-group">
                ...
                <select className="select" value={form.account}
            ...
            <div className="form-group">
              ...
              <input className="input" list="catlist"
                     ...
                     placeholder="e.g., bills, groceries, paycheck" required />
            </div>
